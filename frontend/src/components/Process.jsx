...
export const Process = () => {
  ...
  const lineScale = useSpring(scrollYProgress, { stiffness: 60, damping: 20, mass: 0.6 });
    ...
    <section id="denik" data-testid="process-section" className="border-t border-ink/10 bg-stone px-5 py-28 sm:px-10 sm:py-40">
      <div className="mx-auto max-w-6xl">
        ...
        <ol ref={listRef} className="relative">
          {/* svislá osa časové linie — dokresluje se při scrollu */}
          <span aria-hidden className="absolute bottom-10 left-[2.4rem] top-10 hidden w-px bg-ink/10 sm:left-[3.4rem] sm:block" />
          <motion.span
            aria-hidden
            data-testid="process-timeline-line"
